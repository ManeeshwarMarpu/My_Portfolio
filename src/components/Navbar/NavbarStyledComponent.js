...
// `;
export const Nav = styled.div`
    background-color: ${({ theme }) => theme.nav_bg}; /* Changed from card_light */
    height: 80px;
    display: flex;
    align-items: center;
    justify-content: center;
...
/* ✅ Add this to push content down */
export const PageContent = styled.div`
    margin-top: 90px;  /* ✅ Ensures sections don't overlap */
`;
...
export const NavLogo = styled.div`
    ...
    span {
      ...
      font-size: 20px;
      margin-left: 8px;
      color: ${({ theme }) => theme.text_primary};  /* Ensure text changes with theme */
...
export const NavItems = styled.ul`
    ...
    padding: 0 10px;  /* ✅ Reduces side padding */
    list-style: none;
